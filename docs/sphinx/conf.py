...
project = 'mnsa'
copyright = '{0}, {1}'.format('2019', 'Michael Blanton')
...
htmlhelp_basename = '{0}pdoc'.format('mnsa')
...
man_pages = [
    (master_doc, 'mnsa', u'{0} Documentation'.format(project),
     [author], 1)
]
